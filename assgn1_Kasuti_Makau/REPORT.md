...
| Algorithm    | R gain | G gain | B gain | Result           |
| ------------ | ------ | ------ | ------ | ---------------- |
| Gray world   | 2.3460 | 1.0000 | 1.4230 | Natural blue sky |
| White world  | 1.0813 | 1.0814 | 1.0815 | fails            |
| dcraw preset | 2.2937 | 1.0000 | 1.3687 | Natural blue sky |

White world fails because there is no white objet in the scene
All channel maxes are roughly 0.925, so it applies near-uniform scaling with no color correction

**Preferred algorithm: dcraw preset** because it uses the camera's own calibrated multipliers, making it the most physically grounded choice
